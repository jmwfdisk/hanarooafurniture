...
(function () {
  ...
  var PRIVACY_EFFECTIVE = '2026. 7. 3.';   // 개인정보처리방침 시행일 (개정 시 갱신)
  ...
  var PRIVACY_HTML =
    ...
    '<ul>' +
      '<li>수탁자: Google LLC (Firebase — 회원 인증·데이터베이스·파일 저장)</li>' +
    ...
    '<p>정보주체는 언제든지 자신의 개인정보에 대한 열람·정정·삭제·처리정지를 요청할 수 있습니다. 홈페이지 로그인 후 직접 정정하거나, 아래 개인정보 보호책임자에게 서면·전화·이메일로 요청하면 지체 없이 조치합니다.</p>' +
    '<h4>7. 개인정보의 파기 절차 및 방법</h4>' +
    '<p>전자적 파일 형태의 정보는 복구·재생이 불가능한 방법으로 영구 삭제하고, 종이에 출력된 정보는 분쇄 또는 소각하여 파기합니다.</p>' +
