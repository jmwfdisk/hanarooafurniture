...
(function () {
  ...
  var PRIVACY_EFFECTIVE = '2026. 7. 6.';   // 개인정보처리방침 시행일 (개정 시 갱신)

  var PRIVACY_HTML =
    '<h3>개인정보처리방침</h3>' +
    '<p>' + COMPANY.name + '(이하 "회사")는 「개인정보 보호법」 제30조에 따라 정보주체의 개인정보를 보호하고 이와 관련한 고충을 신속하게 처리할 수 있도록 다음과 같이 개인정보처리방침을 수립·공개합니다.</p>' +
    '<h4>1. 수집하는 개인정보 항목 및 수집 방법</h4>' +
    '<ul>' +
      '<li>회원가입: 성명, 아이디, 이메일, 비밀번호, 연락처, 소속, 직급/직책</li>' +
      '<li>A/S 신청·게시판 문의: 성명, 연락처, 주소, 신청·문의 내용</li>' +
      '<li>서비스 이용 과정에서 자동 생성·수집: 접속 로그, 로그인 유지를 위한 세션 정보</li>' +
      '<li>수집 방법: 홈페이지(회원가입·게시판·A/S 신청) 입력, 서비스 이용 중 자동 생성</li>' +
    '</ul>' +
    '<h4>2. 개인정보의 수집·이용 목적</h4>' +
    '<ul>' +
      '<li>회원 식별·관리 및 임직원 전용 서비스의 접근 권한 관리</li>' +
      '<li>제품·납품·A/S 등 서비스 제공, 문의 응대 및 처리결과 안내</li>' +
      '<li>부정 이용 방지 및 서비스 보안</li>' +
    '</ul>' +
    '<h4>3. 보유 및 이용 기간</h4>' +
    '<p>원칙적으로 수집·이용 목적이 달성되거나 회원 탈퇴 시 지체 없이 파기합니다. 다만 관계 법령에 따라 다음 정보는 해당 기간 동안 보관합니다.</p>' +
    '<ul>' +
      '<li>계약 또는 청약철회 등에 관한 기록: 5년(전자상거래 등에서의 소비자보호에 관한 법률)</li>' +
      '<li>소비자의 불만 또는 분쟁처리에 관한 기록: 3년(동법)</li>' +
      '<li>서비스 접속 로그 기록: 3개월(통신비밀보호법)</li>' +
    '</ul>' +
    '<h4>4. 개인정보 처리의 위탁 및 국외 이전</h4>' +
    '<p>회사는 안정적인 서비스 운영을 위해 아래와 같이 개인정보 처리를 위탁하며, 클라우드 인프라 특성상 개인정보가 국외에 저장·처리될 수 있습니다.</p>' +
    '<ul>' +
      '<li>이전받는 자(수탁자): Google LLC (Firebase — 회원 인증·데이터베이스·파일 저장, 문의: privacy.google.com)</li>' +
      '<li>위탁 업무: 회원 인증 및 데이터의 저장·관리</li>' +
      '<li>이전되는 국가: 미국 등 Google 데이터센터 소재 국가</li>' +
      '<li>이전되는 항목: 제1항의 수집 항목 일체</li>' +
      '<li>이전 방법·시점: 서비스 이용 시 정보통신망을 통해 Google 데이터센터로 이전</li>' +
      '<li>보유·이용 기간: 위탁 계약 종료 또는 회원 탈퇴 시까지</li>' +
      '<li>이전 거부 방법: 아래 개인정보 보호책임자에게 국외 이전 거부를 요청할 수 있습니다. 다만 국외 이전은 서비스 제공에 필수적이므로 거부 시 회원 서비스 이용이 제한될 수 있습니다.</li>' +
    '</ul>' +
    '<h4>5. 개인정보의 제3자 제공</h4>' +
    '<p>회사는 정보주체의 동의 없이 개인정보를 외부에 제공하지 않습니다. 다만 법령에 특별한 규정이 있거나 수사기관의 적법한 요청이 있는 경우는 예외로 합니다.</p>' +
    '<h4>6. 만 14세 미만 아동의 개인정보</h4>' +
    '<p>회사는 만 14세 미만 아동의 개인정보를 수집하지 않으며, 회원가입은 임직원 및 거래처 담당자 등 성인을 대상으로 합니다.</p>' +
    '<h4>7. 개인정보 자동 수집 장치의 설치·운영 및 거부</h4>' +
    '<p>회사 홈페이지는 광고·행태정보 수집 목적의 쿠키를 사용하지 않습니다. 로그인 상태 유지를 위한 세션 정보가 브라우저(sessionStorage)에 일시 저장되며, 브라우저 탭 종료 시 삭제됩니다. 브라우저 설정에서 저장을 차단할 수 있으나 이 경우 로그인 서비스 이용이 제한될 수 있습니다.</p>' +
    '<h4>8. 정보주체의 권리·의무 및 행사 방법</h4>' +
    '<p>정보주체는 언제든지 자신의 개인정보에 대한 열람·정정·삭제·처리정지를 요청할 수 있습니다. 홈페이지 로그인 후 직접 정정하거나, 아래 개인정보 보호책임자(열람청구 접수·처리 부서를 겸함)에게 서면·전화·이메일로 요청하면 지체 없이 조치합니다. 권리 행사는 법정대리인이나 위임을 받은 자를 통해서도 할 수 있습니다.</p>' +
    '<h4>9. 개인정보의 파기 절차 및 방법</h4>' +
    '<p>보유 기간이 경과하거나 처리 목적이 달성된 개인정보는 지체 없이 파기하며, 법령에 따라 보존해야 하는 정보는 별도의 데이터베이스(또는 보관 장소)로 옮겨 분리 보관합니다. 전자적 파일 형태의 정보는 복구·재생이 불가능한 방법으로 영구 삭제하고, 종이에 출력된 정보는 분쇄 또는 소각하여 파기합니다.</p>' +
    '<h4>10. 개인정보의 안전성 확보 조치</h4>' +
    '<p>회사는 비밀번호의 암호화 저장, 접근 권한의 차등 부여 및 통제, 접속 기록의 보관 등 관련 법령이 요구하는 안전성 확보 조치를 취하고 있습니다.</p>' +
    '<h4>11. 개인정보 보호책임자 및 열람청구 접수·처리 부서</h4>' +
    '<ul>' +
    ...
    '</ul>' +
    '<h4>12. 권익침해 구제 방법</h4>' +
    '<p>개인정보 침해로 인한 상담·분쟁조정이 필요한 경우 아래 기관에 문의할 수 있습니다.</p>' +
    '<ul>' +
    ...
    '<p>이 개인정보처리방침은 법령·정책 또는 서비스의 변경에 따라 개정될 수 있으며, 변경 시 홈페이지를 통해 공지합니다.</p>' +
    '<ul>' +
      '<li>2026. 7. 6. 개정(국외 이전 고지 보강, 아동·자동수집장치·열람청구 부서 조항 신설) — 현행</li>' +
      '<li>2026. 7. 3. 전부 개정</li>' +
    '</ul>' +
    '<p style="margin-top:14px;color:#888;font-size:12px;">시행일자: ' + PRIVACY_EFFECTIVE + '</p>';

  var EMAIL_HTML =
    '<h3>이메일 무단 수집거부</h3>' +
    '<p>본 웹사이트에 게시된 이메일 주소가 전자우편 수집 프로그램이나 그 밖의 기술적 장치를 이용하여 무단으로 수집되는 것을 거부하며, 이를 위반 시 「정보통신망 이용촉진 및 정보보호 등에 관한 법률」 제50조의2에 따라 처벌받을 수 있음을 유념하시기 바랍니다.</p>' +
    '<p style="color:#555;font-size:13px;">게시일: ' + PRIVACY_EFFECTIVE + '</p>' +
  ...
  function buildSiteLinks() {
    ...
    document.querySelectorAll('.partner-logos').forEach(function (pl) {
      ...
      function positionMenu() {
        ...
        menu.style.minWidth = Math.max(170, r.width) + 'px';
        var mw = menu.offsetWidth || 170;
        var left = Math.min(Math.max(8, r.left), vw - mw - 8);
        menu.style.left = left + 'px';
        var spaceBelow = vh - r.bottom, spaceAbove = r.top;
        if (spaceBelow < 180 && spaceAbove > spaceBelow) { // 위로 펼침
          menu.style.top = 'auto';
          menu.style.bottom = (vh - r.top + 6) + 'px';
          menu.style.maxHeight = Math.min(340, spaceAbove - 12) + 'px';
        } else {                                            // 아래로 펼침
          menu.style.bottom = 'auto';
          menu.style.top = (r.bottom + 6) + 'px';
          menu.style.maxHeight = Math.min(340, spaceBelow - 12) + 'px';
        }
      }
      function closeMenu() {
      ...
      window.addEventListener('scroll', function () { if (wrap.classList.contains('open')) positionMenu(); }, true);
    });
  }
